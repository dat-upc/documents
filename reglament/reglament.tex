...
% Canviar l'espaiat entre capítols de l'índex
\renewcommand\cftsecafterpnum{\vskip2.5pt}
\renewcommand\cftsubsecafterpnum{\vskip1.5pt}
\renewcommand\cftsubsubsecafterpnum{\vskip1.5pt}
...
\begin{enumerate}[\thesubsubsection.1]
	\item El delegat de centre nomena i destitueix els sotsdelegats d'entre els membres de la delegació i els assigna funcions, sense perjudici de les funcions que aquest reglament els atribueixi.
	\item El delegat de centre ha de notificar el nomenament i cessament de sotsdelegats de centre al Ple.
	\item Els sotsdelegats cessen en el moment en què el nou delegat de centre pren possessió del càrrec.
	\item Els sotsdelegats poden ser cessats pel Ple a proposta de, com a mínim, un terç dels seus membres. L'aprovació del cessament requereix el vot favorable de dos terços dels membres del Ple.
\end{enumerate}

\subsubsection{Funcions}
\begin{enumerate}[\thesubsubsection.1]
	\item Corresponen als sotsdelegats de centre les funcions següents:
	\begin{enumerate}[a)]
		\item Assistir al delegat de centre en les seves funcions.
		\item Exercir les funcions que els delegui el delegat de centre.
	\end{enumerate}
	\item En cas d'absència, malaltia, vacant o revocació del delegat de centre n'assumeix les funcions el sotsdelegat de centre que el delegat de centre ha designat, o, si no hi ha cap designació, el sotsdelegat de centre que té un nomenament més antic, seguint un ordre decreixent d'edat.
\end{enumerate}

\subsection{El secretari}
\subsubsection{Naturalesa i funcions}
\begin{enumerate}[\thesubsubsection.1]
	\item El secretari gestiona i custodia la documentació, comunicació i actes de la delegació, i dona fe dels acords presos.
	\item El secretari també actua com a secretari del Ple i del Consell de la Delegació.
	\item El delegat de centre designa el secretari i ho notifica al Ple.
	\item El secretari cessa en el moment en què el delegat de centre és cessat i continua en funcions fins que el nou secretari pren possessió del càrrec.	
\end{enumerate}

\subsection{El tresorer}
\subsubsection{Naturalesa i funcions}
\begin{enumerate}[\thesubsubsection.1]
	\item El tresorer gestiona el pressupost que té assignat la Delegació.
	\item El delegat de centre designa el tresorer i ho notifica al Ple.
	\item El tresorer cessa en el moment en què el delegat de centre és cessat i continua en funcions fins que el nou tresorer pren possessió del càrrec.
\end{enumerate}
\newpage
